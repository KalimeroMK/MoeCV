<div class="container">
	<div class="row">
        <div class="col-md-5 col-sm-5 title">
			<h1>@lang('mainPage.main_page_title')</h1>
            <h2 class="p-1" style="padding-right: 0.5em; font-size: 16px;">@lang('mainPage.main_page_small_title')</h2>
			<a href="{{route('login-route')}}"><button class="btn btn-lg">@lang('mainPage.main_page_button')</button></a>
		</div>
