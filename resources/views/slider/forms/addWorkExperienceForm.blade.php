<div class="col-md-5 card" id="addWorkExperienceForm" data-isedit="0">
    <div>
        <h4>@lang('slider.edit_page_add_experience_info_title')</h4>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1">@lang('slider.edit_page_add_experience_info_work_position')</label>
            <input type="text" class="form-control" id="workPosition" maxlength="255" style="width: 100%">
        </div>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1">@lang('slider.edit_page_add_experience_info_company')</label>
            <input type="text" class="form-control" id="company" maxlength="255" style="width: 100%">
        </div>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1">@lang('slider.edit_page_add_experience_info_company_webpage')</label>
            <input type="text" class="form-control" id="companyWebpage" maxlength="255" style="width: 100%">
        </div>

        <div class="form-group form-inline">
            <label for="exampleInputEmail1">@lang('slider.edit_page_add_experience_info_job_description')</label>
        ...
        <button class="btn btn-primary pull-right" id="saveWorkExperienceButton">@lang('slider.edit_page_save')</button>
