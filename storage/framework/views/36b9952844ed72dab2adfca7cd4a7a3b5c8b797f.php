<div class="col-md-5 card" id="addEducationForm">
    <div>
        <h4><?php echo app('translator')->getFromJson('slider.edit_page_education'); ?></h4>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1"><?php echo app('translator')->getFromJson('slider.edit_page_education_info_degree'); ?></label>
            <input type="text" class="form-control" id="degree" maxlength="255" style="width: 100%">
        </div>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1"><?php echo app('translator')->getFromJson('slider.edit_page_education_info_institution'); ?></label>
            <input type="text" class="form-control" id="institution" maxlength="255" style="width: 100%">
        </div>
        <div class="form-group form-inline">
            <label for="exampleInputEmail1"><?php echo app('translator')->getFromJson('slider.edit_page_education_webpage'); ?></label>
            <input type="text" class="form-control" id="institutionWebpage" maxlength="255" style="width: 100%">
        </div>

        <div class="form-group form-inline">
            <label for="exampleInputEmail1"><?php echo app('translator')->getFromJson('slider.edit_page_education_description'); ?></label>
        ...
        <button class="btn btn-primary pull-right" id="saveEducationButton"><?php echo app('translator')->getFromJson('slider.edit_page_save'); ?></button>
